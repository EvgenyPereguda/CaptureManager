...
CaptureManagerToWinRTProxy::IIntPtr^ DirectXPanelBase::getSwapChain()
{
	...
	Platform::IntPtr lSwapChain(m_swapChain.Get());

	lresult = CaptureManagerToWinRTProxy::CaptureManager::getInstance()->getIntPtr(lSwapChain);
