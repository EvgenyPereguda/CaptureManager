...
CaptureManagerToWinRTProxy::IEVRStreamControl^ CaptureManager::getIEVRStreamControl()
{
	CaptureManagerToWinRTProxy::IEVRStreamControl^ lresult = nullptr;
	...
	do
	{
		...
		CComPtrCustom<::IEVRStreamControl> lIEVRStreamControl;

		CHK(mICaptureManagerControl->createMisc(IID_PPV_IUNKNOWN_ARGS(&lIEVRStreamControl)));

		lresult = ref new EVRStreamControl(IntPtr(lIEVRStreamControl.get()));
...
CaptureManagerToWinRTProxy::IIntPtr^ CaptureManager::getIntPtr(Platform::IntPtr aIntPtr)
{
	CaptureManagerToWinRTProxy::IIntPtr^ lresult = nullptr;
	...
	do
	{
		...
		lresult = ref new CaptureManagerToWinRTProxy::WrapperIntPtr(aIntPtr);
