...
{
	if (args->Kind == Windows::ApplicationModel::Activation::ActivationKind::CameraSettings)
	{
...
void WindowsStoreCam::App::Application_Suspending(Platform::Object^ sender, Platform::Object^ e)
{
