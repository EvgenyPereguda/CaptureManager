...
#include "../../CaptureManagerSource/ScreenCaptureProcessor/ScreenCaptureProcessorGDI.h"
...
{
	TEST_CLASS(UnitTestScreenCaptureProcessorGDI)
	{
	public:
		...
		TEST_METHOD(getFrendlyName)
		{
			...
			CComPtrCustom<ICaptureProcessor> lScreenCaptureProcessor = new ScreenCaptureProcessorGDI;
			...
			Assert::IsFalse(lresult,
				std::wstring(std::wstring(L"ScreenCaptureProcessorGDI: getFrendlyName cannot be executed!!! ") + 
		...
		TEST_METHOD(getSymbolicLink)
		{
			...
			Assert::IsFalse(lresult,
				std::wstring(std::wstring(L"ScreenCaptureProcessorGDI: getSymbolicLink cannot be executed!!! ") + 
				std::wstring(DataParser::getHRESULTDescription(lresult))).c_str()
				);
		...
		TEST_METHOD(getMediaTypes)
		{
			...
			CComPtrCustom<ScreenCaptureProcessorGDI> lScreenCaptureProcessor = new ScreenCaptureProcessorGDI;
			...
			Assert::IsFalse(lresult,
				std::wstring(std::wstring(L"ScreenCaptureProcessorGDI: getMediaTypes cannot be executed!!! ") + 
				std::wstring(DataParser::getHRESULTDescription(lresult))).c_str()
				);
		}
		...
		TEST_METHOD(readImage)
		{
			...
			std::vector<ScreenCaptureProcessorGDI::ScreenCaptureConfig> lVectorScreenCaptureConfigs;
		...
		TEST_METHOD(getNewSample)
		{
			...
			Assert::IsFalse(lresult,
				std::wstring(std::wstring(L"ScreenCaptureProcessorGDI: setCurrentMediaType() cannot be executed!!! ") + 
				std::wstring(DataParser::getHRESULTDescription(lresult))).c_str()
				);
			...
			Assert::IsFalse(lresult,
				std::wstring(std::wstring(L"ScreenCaptureProcessorGDI: getNewSample() cannot be executed!!! ") + 
				std::wstring(DataParser::getHRESULTDescription(lresult))).c_str()
				);
			...
			Assert::IsFalse(lresult,
				std::wstring(std::wstring(L"ScreenCaptureProcessorGDI: stop() cannot be executed!!! ") +
				std::wstring(DataParser::getHRESULTDescription(lresult))).c_str()
				);
		}
	};
